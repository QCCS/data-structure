...
(function (a) {
    var c = Object.prototype.toString, d = Array.prototype;
    ...
    a.unique = function (a) {
        ...
        if (Object.keys) c = Object.keys(d); else for (var i in d) d.hasOwnProperty(i) && c.push(i);
        return c
    };
    a.keys = Object.keys;
...
(function (a, c) {
    ...
    a.log = function () {
        if ("undefined" !== typeof console) {
            var a = d.slice.call(arguments), e = "log";
...
(function (a, c, d) {
    ...
    function e(a) {
        ...
        for (var c = a.split("/"), b = [], d, f = 0; f < c.length; f++) if (d = c[f], ".." === d) {
    ...
    function o(a) {
        var a = e(a), c = a.charAt(a.length - 1);
        if ("/" === c) return a;
    ...
    var r = /.*(?=\/.*$)/, j = /([^:\/])\/\/+/g, g = /\.(?:css|js)$/, n = /^(.*?\w)(?:\/|$)/, h = {}, d = d.location,
...
(function (a, c) {
    ...
    function e(a, c) {
        var b;
        if (f) a.sheet && (b = !0); else if (a.sheet) try {
    ...
    var k = document, i = k.head || k.getElementsByTagName("head")[0] || k.documentElement,
        m = i.getElementsByTagName("base")[0], r = /\.css(?:\?|$)/i, j = /loaded|complete|undefined/, g, n;
    a.fetch = function (c, f, e) {
        var j = r.test(c), h = document.createElement(j ? "link" : "script");
...
(function (a) {
    ...
    a.parseDependencies = function (d) {
        var b = [], e, d = d.replace(/^\s*\/\*[\s\S]*?\*\/\s*$/mg, "").replace(/^\s*\/\/.*$/mg, "");
...
(function (a, c, d) {
    ...
    function j(a,
        ...
        if (d.length) {
            ...
            for (var e = 0; e < d.length; e++) if (j(g[d[e]], b)) return !0
        }
        return !1
    }

    var g = {}, n = {}, h = [], f = {FETCHING: 1, FETCHED: 2, SAVED: 3, READY: 4, COMPILING: 5, COMPILED: 6};
    ...
    b.prototype._load = function (a, d) {
        ...
        if (0 === h) d(); else for (var m = h, j = 0; j < h; j++) (function (a) {
            function c() {
                d = g[a];
                if (d.status >= f.SAVED) {
                    var q = r(d);
    ...
    b._define = function (a, b, d) {
        ...
        if (a) var g = e(a); else document.attachEvent && ((f = c.getCurrentScript()) && (g = c.unParseMap(c.getScriptAbsoluteSrc(f))), g || c.log("Failed to derive URI from interactive script for:", d.toString(), "warn"));
        f = {id: a, dependencies: b, factory: d};
        g ? v.push(k(g, f)) : t = f
    };
    ...
    b._fetch = c.fetch;
    b.cache = g;
    var p = {}, x = {}, s = {}, t = null, v = [], u = [], w = new b(c.pageUri, f.COMPILED);
    a.use = function (c, b) {
        var f = d.preload;
    ...
    a.find = b._find;
    a.modify = b._modify;
    a.pluginSDK = {Module: b, util: c, config: d}
})(seajs, seajs._util, seajs._config);
(function (a, c, d) {
    var b = "seajs-ts=" + c.now(), e = document.getElementById("seajsnode");
    e || (e = document.getElementsByTagName("script"), e = e[e.length - 1]);
    var o = c.getScriptAbsoluteSrc(e) || c.pageUri, o = c.dirname(function (a) {
        if (a.indexOf("??") === -1) return a;
        var b = a.split("??"), a = b[0], b = c.filter(b[1].split(","), function (a) {
...
(function (a, c, d) {
    ...
    a.config({alias: {seajs: c.loaderDir}});
    if (-1 < d.location.search.indexOf("seajs-debug") || -1 < document.cookie.indexOf("seajs=1")) a.config({debug: 2}).use("seajs/plugin-debug"), a._use = a.use, a._useArgs = [], a.use = function () {
...
(function (a, c, d) {
    var b = a._seajs;
    if (b && !b.args) d.seajs = a._seajs; else {
        d.define = a.define;
        c.main && a.use(c.main);
        if (c = (b || 0).args) {
            d = {"0": "config", 1: "use", 2: "define"};
